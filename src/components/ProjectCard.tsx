      ...
      >
        ...
        <div className="px-[10px] pt-1 pb-1">
          <div className="flex items-center gap-1.5 min-w-0">
            ...
            {(project.maker.id === "platforma" || project.maker.id === "bygge" || project.maker.id === "durov-house" || project.maker.id === "histhut" || project.maker.id === "tanhouse" || project.maker.id === "countryhouse") && (
