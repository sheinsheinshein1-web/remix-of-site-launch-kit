      ...
      >
        ...
        <div className="px-[10px] pt-1 pb-1">
          <div className="flex items-center gap-1.5 min-w-0">
            ...
            {(project.maker.id === "platforma" || project.maker.id === "bygge" || project.maker.id === "durov-house" || project.maker.id === "histhut" || project.maker.id === "countryhouse" || project.maker.id === "cuba-dom" || project.maker.id === "idolhouse" || project.maker.id === "woodalp" || project.maker.id === "boxmate" || project.maker.id === "uvhouse" || project.maker.id === "asterius-house" || project.maker.id === "smola-house" || project.maker.id === "ultradomspb" || project.maker.id === "freedom-naturi" || project.maker.id === "chebwood" || project.maker.id === "campingdom" || project.maker.id === "pslcomp" || project.maker.id === "domnasm" || project.maker.id === "blackmodule" || project.maker.id === "domm" || project.maker.id === "my-module") && (
