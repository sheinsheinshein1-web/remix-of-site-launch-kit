...
const CookieConsentBanner = () => {
  ...
  return (
    ...
    >
      <div className="mx-auto grid w-full max-w-[1120px] gap-4 rounded-[var(--radius)] border border-border bg-background p-4 shadow-[0_14px_40px_rgba(31,36,43,0.14)] sm:p-5 md:grid-cols-[minmax(0,1fr)_auto] md:items-center md:gap-8">
        <div className="min-w-0">
          ...
          <Link
            to="/legal/cookies/"
            className="mt-2 inline-flex min-h-11 items-center text-[13px] font-medium text-foreground transition-colors hover:text-primary focus-visible:rounded-[var(--radius)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/30 md:min-h-9 md:text-[14px]"
          >
        ...
        <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 md:min-w-[330px]">
          <Button
            ...
            className="min-h-11 rounded-[var(--radius)] px-5"
          >
            Только необходимые
          </Button>
          <Button
