...
const aboutByMakerId: Record<string, string> = {
  ...
  domakarkas:
    "ДомаКаркас — каталог каркасных домов СтройКомфорт из Санкт-Петербурга. В подборке представлены одноэтажные дома площадью от 108 до 130 м² с террасами, сауной, вторым светом и панорамным остеклением.",
  "sk-garmoniya":
