...
const aboutByMakerId: Record<string, string> = {
  ...
  "prime-modul":
    "Прайм Модуль — производитель каркасных и модульных домов из Пермского края. В каталоге представлены каркасные дома площадью от 42 до 200 м² с террасами, панорамными окнами и современными планировками.",
  utkino:
