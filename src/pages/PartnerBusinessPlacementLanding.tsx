        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>Стоимость размещения в разделе «Бизнес» — 99 000 ₽ за 12 месяцев. В неё входят подготовка и публикация согласованных проектов, связь со страницей компании и отображение фактической географии доставки.</p>
            </>
          ),
