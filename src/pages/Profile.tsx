    ...
    <div className="min-h-screen bg-secondary pb-20">
      ...
      <div className="bg-card rounded-xl mx-4 mt-3 overflow-hidden">
        ...
        <button onClick={() => navigate("/messages")} className="flex items-center gap-3 w-full px-4 py-3.5 border-b border-border">
          <img src={projectTaiga} alt="Тайга 72" className="w-9 h-9 rounded-[var(--radius)] object-cover flex-shrink-0" loading="lazy" decoding="async" />
        ...
        <div className="flex items-center gap-3 px-4 py-3.5">
          <img src={projectKedr} alt="Кедр 24" className="w-9 h-9 rounded-[var(--radius)] object-cover flex-shrink-0" loading="lazy" decoding="async" />
          <div className="flex-1 text-left min-w-0">
            <div className="flex items-center gap-2">
