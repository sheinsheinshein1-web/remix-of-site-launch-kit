            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-1.5 min-w-0">
                  ...
                  {(project.makerId === "platforma" || project.makerId === "bygge" || project.makerId === "durov-house" || project.makerId === "histhut" || project.makerId === "countryhouse" || project.makerId === "cuba-dom" || project.makerId === "idolhouse" || project.makerId === "woodalp" || project.makerId === "boxmate" || project.makerId === "uvhouse" || project.makerId === "asterius-house" || project.makerId === "smola-house" || project.makerId === "ultradomspb" || project.makerId === "freedom-naturi" || project.makerId === "chebwood" || project.makerId === "campingdom" || project.makerId === "pslcomp" || project.makerId === "domnasm" || project.makerId === "blackmodule" || project.makerId === "domm" || project.makerId === "my-module" || project.makerId === "4modul") && (
