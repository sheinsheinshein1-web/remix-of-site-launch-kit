  ...
  <PartnerDetailLanding
    ...
    sections={[
      ...
      },
      {
        ...
        content: (
          <>
            <p>Вознаграждение составляет 5% от полной суммы договора и выплачивается целиком сразу после состоявшейся сделки. Вы получаете новые обращения без авансовых расходов и платите только за реальный результат — проданный модульный дом.</p>
