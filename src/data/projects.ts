...
// 3. Для КАЖДОЙ фотографии в gallery укажи:
...
//    Для реальных фото с небом/травой — НЕ ставь edgeBleed (даст белые полосы).
//    Поэтажные планы: { fit: "contain" } без blur.
...
// 6. Добавь текст «о компании» в `aboutByMakerId` в src/pages/Partner.tsx.
//
// Всё остальное (карточка /partner/:id, счётчик проектов, manufacturers,
// makersById, projectGalleries и т.п.) рассчитывается автоматически.
// ============================================================================
