...
import modulcampGollandiyaPlan from "@/assets/modulcamp/gollandiya/plan.webp";
import modulcampShale_1 from "@/assets/modulcamp/shale/01.webp";
import modulcampShalePlan from "@/assets/modulcamp/shale/plan.webp";
import modulcampFinlandiya_1 from "@/assets/modulcamp/finlandiya/01.webp";
import modulcampDaniya_1 from "@/assets/modulcamp/daniya/01.webp";
import elmacoIvor_1 from "@/assets/elmaco/ivor/01.webp";
import elmacoIvorPlan from "@/assets/elmaco/ivor/plan.webp";
import elmacoLukas_1 from "@/assets/elmaco/lukas/01.webp";
import elmacoLukasPlan from "@/assets/elmaco/lukas/plan.webp";
import elmacoJung_1 from "@/assets/elmaco/jung/01.webp";
import elmacoTor_1 from "@/assets/elmaco/tor/01.webp";
import elmacoTorPlan from "@/assets/elmaco/tor/plan.webp";
import elmacoOscar_1 from "@/assets/elmaco/oscar/01.webp";
import elmacoOscarPlan from "@/assets/elmaco/oscar/plan.webp";
import novatorRadius_1 from "@/assets/novator/radius/01.webp";
import novatorN3_1 from "@/assets/novator/n3/01.webp";
import novatorN2_1 from "@/assets/novator/n2/01.webp";
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    technology: "Модульный дом", completion: "Под ключ", insulation: "круглогодичный",
    features: ["75 м²", "Барнхаус", "Панорамные окна"], style: "Барнхаус", landSize: "6–10 соток",
    hasRealPhotos: true, hasShowroom: true, hasInstallment: false,
  },
  {
    ...
    suitableFor: ["Для семьи", "ПМЖ", "Загородный дом"],
    technology: "Модульный дом", completion: "Под ключ", insulation: "круглогодичный",
    features: ["108 м²", "3 спальни", "Семейный формат"], style: "Современный", landSize: "8–12 соток",
    hasRealPhotos: true, hasShowroom: true, hasInstallment: false,
  },
  {
    ...
    technology: "Модульный дом", completion: "Под ключ", insulation: "круглогодичный",
    features: ["35 м²", "Компактный формат", "Быстрый монтаж"], style: "Современный", landSize: "4–7 соток",
    hasRealPhotos: true, hasShowroom: true, hasInstallment: false,
  },
  {
    ...
    technology: "Модульный дом", completion: "Под ключ", insulation: "круглогодичный",
    features: ["60 м²", "2 спальни", "Современный фасад"], style: "Современный", landSize: "5–9 соток",
    hasRealPhotos: true, hasShowroom: true, hasInstallment: false,
  },
  {
    ...
    suitableFor: ["Для семьи", "ПМЖ", "Загородный дом"],
    technology: "Модульный дом", completion: "Под ключ", insulation: "круглогодичный",
    features: ["90 м²", "3 спальни", "Барнхаус"], style: "Барнхаус", landSize: "7–12 соток",
    hasRealPhotos: true, hasShowroom: true, hasInstallment: false,
  },
  {
    ...
    gallery: [
      { image: modulcampBarnHouse_1, type: "photo" },
      { image: modulcampBarnHousePlan, type: "plan", fit: "contain" },
    ],
    likes: 96, rating: 4.8,
    suitableFor: ["Дача", "Пара", "Гостевой дом"],
    technology: "Модульный дом", completion: "Под ключ", insulation: "круглогодичный",
  ...
  },
  {
    ...
    gallery: [
      { image: modulcampGollandiya_1, type: "photo" },
      { image: modulcampGollandiyaPlan, type: "plan", fit: "contain" },
    ],
    likes: 108, rating: 4.9,
    suitableFor: ["Для семьи", "ПМЖ", "Загородный дом"],
    technology: "Модульный дом", completion: "Под ключ", insulation: "круглогодичный",
    features: ["126 м²", "3 спальни", "Планировка"], style: "Современный", landSize: "8–12 соток",
    hasRealPhotos: true, hasShowroom: false, hasInstallment: false,
  },
  {
    ...
    gallery: [
      { image: modulcampShale_1, type: "photo" },
      { image: modulcampShalePlan, type: "plan", fit: "contain" },
    ],
    likes: 101, rating: 4.8,
    suitableFor: ["Дача", "ПМЖ", "Для семьи"],
    technology: "Модульный дом", completion: "Под ключ", insulation: "круглогодичный",
    features: ["82 м²", "Шале", "2 спальни"], style: "Шале", landSize: "6–10 соток",
    hasRealPhotos: true, hasShowroom: false, hasInstallment: false,
  },
  {
    ...
    suitableFor: ["Дача", "Гостевой дом", "Аренда"],
    technology: "Модульный дом", completion: "Под ключ", insulation: "круглогодичный",
    features: ["36 м²", "Компактный дом", "1 спальня"], style: "Скандинавский", landSize: "4–7 соток",
    hasRealPhotos: true, hasShowroom: false, hasInstallment: false,
  },
  {
    ...
    likes: 100, rating: 4.8,
    suitableFor: ["Для семьи", "Дача", "ПМЖ"],
    technology: "Модульный дом", completion: "Под ключ", insulation: "круглогодичный",
    features: ["81 м²", "2 спальни", "Скандинавский стиль"], style: "Скандинавский", landSize: "6–10 соток",
    hasRealPhotos: true, hasShowroom: false, hasInstallment: false,
  },
  {
    ...
    gallery: [
      { image: elmacoIvor_1, type: "photo" },
      { image: elmacoIvorPlan, type: "plan", fit: "contain" },
    ],
    likes: 105, rating: 4.9,
    suitableFor: ["Дача", "Пара", "Гостевой дом"],
    technology: "Модульный дом", completion: "Под ключ", insulation: "круглогодичный",
    features: ["41 м²", "1 спальня", "Планировка"], style: "Современный", landSize: "4–7 соток",
    hasRealPhotos: false, hasShowroom: true, hasInstallment: false,
  },
  {
    ...
    gallery: [
      { image: elmacoLukas_1, type: "photo" },
      { image: elmacoLukasPlan, type: "plan", fit: "contain" },
    ],
    likes: 111, rating: 4.9,
    suitableFor: ["Дача", "ПМЖ", "Пара"],
    technology: "Модульный дом", completion: "Под ключ", insulation: "круглогодичный",
    features: ["55 м²", "1 спальня", "Под ключ"], style: "Современный", landSize: "5–8 соток",
    hasRealPhotos: false, hasShowroom: true, hasInstallment: false,
  },
  {
    ...
    suitableFor: ["Дача", "Гостевой дом", "Аренда"],
    technology: "Модульный дом", completion: "Под ключ", insulation: "круглогодичный",
    features: ["27,6 м²", "Компактный дом", "1 спальня"], style: "Современный", landSize: "3–6 соток",
    hasRealPhotos: false, hasShowroom: true, hasInstallment: false,
  },
  {
    ...
    gallery: [
      { image: elmacoTor_1, type: "photo" },
      { image: elmacoTorPlan, type: "plan", fit: "contain" },
    ],
    likes: 101, rating: 4.8,
    suitableFor: ["Дача", "Гостевой дом", "Аренда"],
    technology: "Модульный дом", completion: "Под ключ", insulation: "круглогодичный",
    features: ["27,2 м²", "1 спальня", "Планировка"], style: "Современный", landSize: "3–6 соток",
    hasRealPhotos: false, hasShowroom: true, hasInstallment: false,
  },
  {
    ...
    gallery: [
      { image: elmacoOscar_1, type: "photo" },
      { image: elmacoOscarPlan, type: "plan", fit: "contain" },
    ],
    likes: 114, rating: 4.9,
    suitableFor: ["Для семьи", "ПМЖ", "Загородный дом"],
    technology: "Модульный дом", completion: "Под ключ", insulation: "круглогодичный",
    features: ["147 м²", "2 спальни", "Большой дом"], style: "Современный", landSize: "10–15 соток",
    hasRealPhotos: false, hasShowroom: true, hasInstallment: false,
  },
  {
    ...
    likes: 104, rating: 4.9,
    suitableFor: ["Дача", "Глэмпинг", "Аренда"],
    technology: "Модульный дом", completion: "Под ключ", insulation: "круглогодичный",
    features: ["28 м²", "Компактный модуль", "Глэмпинг"], style: "Современный", landSize: "3–6 соток",
    hasRealPhotos: false, hasShowroom: true, hasInstallment: false,
  },
  {
    ...
    likes: 92, rating: 4.8,
    suitableFor: ["Глэмпинг", "Гостевой дом", "Аренда"],
    technology: "Модульный дом", completion: "Под ключ", insulation: "круглогодичный",
    features: ["16,5 м²", "Компактный модуль", "Готовое решение"], style: "Современный", landSize: "2–5 соток",
    hasRealPhotos: false, hasShowroom: true, hasInstallment: false,
  },
  {
    ...
    likes: 91, rating: 4.8,
    suitableFor: ["Глэмпинг", "Гостевой дом", "Дача"],
    technology: "Модульный дом", completion: "Под ключ", insulation: "круглогодичный",
    features: ["16,5 м²", "Малый модуль", "Под ключ"], style: "Современный", landSize: "2–5 соток",
    hasRealPhotos: false, hasShowroom: true, hasInstallment: false,
  },
  {
    ...
    likes: 94, rating: 4.8,
    suitableFor: ["Глэмпинг", "Дача", "Гостевой дом"],
    technology: "Модульный дом", completion: "Под ключ", insulation: "круглогодичный",
    features: ["16,5 м²", "1 спальня", "Компактный формат"], style: "Современный", landSize: "2–5 соток",
    hasRealPhotos: false, hasShowroom: true, hasInstallment: false,
  },
  {
    ...
    suitableFor: ["Дача", "ПМЖ", "Для семьи"],
    technology: "Модульный дом", completion: "Под ключ", insulation: "круглогодичный",
    features: ["46 м²", "2 спальни", "Под ключ"], style: "Современный", landSize: "4–7 соток",
    hasRealPhotos: false, hasShowroom: true, hasInstallment: false,
  },
  {
    ...
    suitableFor: ["Дача", "Гостевой дом", "Аренда"],
    technology: "Модульный дом", completion: "Под ключ", insulation: "круглогодичный",
    features: ["29 м²", "Барнхаус", "Компактный дом"], style: "Барнхаус", landSize: "3–6 соток",
    hasRealPhotos: false, hasShowroom: true, hasInstallment: false,
  },
  {
  ...
  },
  {
    ...
    suitableFor: ["Для семьи", "ПМЖ", "Дача"],
    technology: "Модульный дом", completion: "Под ключ", insulation: "круглогодичный",
    features: ["65 м²", "2 спальни", "Барнхаус"], style: "Барнхаус", landSize: "6–10 соток",
    hasRealPhotos: false, hasShowroom: true, hasInstallment: false,
  },
  {
    ...
    likes: 116, rating: 4.9,
    suitableFor: ["Для семьи", "ПМЖ", "Загородный дом"],
    technology: "Модульный дом", completion: "Под ключ", insulation: "круглогодичный",
    features: ["103 м²", "3 спальни", "Большой дом"], style: "Барнхаус", landSize: "8–14 соток",
    hasRealPhotos: false, hasShowroom: true, hasInstallment: false,
  },
  {
    ...
    suitableFor: ["Дача", "Пара", "Гостевой дом"],
    technology: "Модульный дом", completion: "Под ключ", insulation: "круглогодичный",
    features: ["41 м²", "1 спальня", "Барнхаус"], style: "Барнхаус", landSize: "4–7 соток",
    hasRealPhotos: false, hasShowroom: true, hasInstallment: false,
  },
  {
